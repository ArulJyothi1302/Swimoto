    ...
    return (
      <div className="about-us p-4 border border-solid border-gray-400 rounded-lg shadow-md shadow-slate-400 hover:shadow-blue-500">
        ...
        <div className="User p-4  text-justify m-4 bg-gray-300 rounded-md">
          <img
            className="profile w-24 rounded-full my-0 mx-auto"
            src={avatar_url}
            alt="profile"
          />
          ...
          <p className="p-2">
            Contact:
            <a className="text-blue-900" href={Contact} target="_blank">
              Twitter
            </a>
          </p>
          <button
            className="px-3 py-1 rounded-lg  bg-gray-100 ease-in duration-300"
            onClick={() => {
